package TCPConsoleBasedTextTranslationServerApplication;
 ...
 * for text translation in console.
 * 
 * This class will translate the text input from server to
	...
	public static void main (String [] args) throws IOException
	{
		...
		translate.createData();
				...
				try
				{
					...
					// 1. bind request to a port number, 1111
					int portNo = 1111;
