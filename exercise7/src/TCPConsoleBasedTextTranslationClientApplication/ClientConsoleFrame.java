package TCPConsoleBasedTextTranslationClientApplication;
 ...
 */
public class ClientConsoleFrame  extends JFrame implements ActionListener{
	...
	{	
		if(e.getSource()== bm)
		{
			...
			ClientConsoleApplication.btnPressed();
